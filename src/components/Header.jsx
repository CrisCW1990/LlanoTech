    ...
    <header className="sticky top-0 bg-white border-b border-gray-100 z-40 px-4 py-3 md:py-4 shadow-sm">
      <div className="max-w-7xl mx-auto flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-4 relative h-12 md:h-auto">
          ...
          <button
            className="text-brand-black hover:text-gray-600 transition-colors p-1 absolute left-0 top-1/2 -translate-y-1/2 md:relative md:top-auto md:translate-y-0"
            aria-label="Abrir menú"
          >
            <svg className="w-7 h-7 text-brand-black" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <button
              ...
              className="md:hidden flex items-center text-brand-black hover:text-gray-600 transition-colors absolute right-0 top-1/2 -translate-y-1/2"
            ...
            <button
              onClick={() => setIsCartOpen(true)}
              className="hidden md:flex items-center gap-2 text-brand-black hover:text-gray-600 transition-colors"
              aria-label="Abrir carrito"
            >
              <div className="relative">
                <svg className="w-7 h-7 text-brand-black" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
